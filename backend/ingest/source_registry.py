...
SOURCES = (
    ...
    {"source_id": "hyperliquid_sol_usd", "provider": "Hyperliquid", "category": "websocket_market_price", "enabled": True, "expected_cadence_seconds": 60, "authoritative": False, "fallback_chain": [], "storage_target": "market_ticks+redis_snapshot", "snapshot_key": "market:hyperliquid:SOL_PERP", "supported_markets": ["BTC-PERP", "ETH-PERP", "SOL-PERP"], "description": "Read-only Hyperliquid BTC/ETH/SOL perpetual mark, mid, and oracle context."},
