...
SOURCES = (
    ...
    {"source_id": "hyperliquid_sol_usd", "provider": "Hyperliquid", "category": "derivatives_market_context", "enabled": True, "expected_cadence_seconds": 60, "authoritative": False, "execution_eligible_reference_price": False, "fallback_chain": [], "storage_target": "market_ticks+redis_snapshot", "snapshot_key": "market:hyperliquid:SOL_PERP", "supported_markets": ["BTC-PERP", "ETH-PERP", "SOL-PERP"], "representative_price": "mark_price", "description": "Scheduled read-only Hyperliquid BTC/ETH/SOL perpetual mark, mid, oracle, open-interest, premium, and raw-funding context; not canonical spot authority."},
